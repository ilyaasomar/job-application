        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <nav className="flex flex-wrap gap-x-8 gap-y-2">
              <a
                href="#"
                className="text-xs font-medium text-slate-500 uppercase tracking-wider hover:text-slate-900 transition-colors"
              >
                About Curator
              </a>
              <a
            ...
            <p className="text-xs text-slate-400 uppercase tracking-wide max-w-xs">
              © 2024 The Architectural Curator. Designed for Professionals.
            </p>
          </div>
        </div>
      </footer>
